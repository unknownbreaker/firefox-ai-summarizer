...
function buildArticlePrompt(presetInstruction) {
  return `The attached file contains the full text of an article. Summarize it as though the text from the article is pasted directly into this conversation.
